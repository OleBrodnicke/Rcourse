...
The head always point to the commit that I am working ong
git tag -a 'V.1' -m 'Version 1' gives one of your versions a tag that you want to access later
git checkout lets you move the head back
## R Markdown
